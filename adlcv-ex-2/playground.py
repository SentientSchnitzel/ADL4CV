...
def image_to_patches(image, patch_size, image_grid=True):
    ...
    if image_grid:
        ...
        """
        patches = rearrange(image, 'b c (h ph) (w pw) -> b c h ph w pw', ph=patch_h, pw=patch_w)
        ...
        """
        patches = rearrange(patches, 'b c h ph w pw -> b (h w) c ph pw')
    else:
        """
        ...
        """
        patches = rearrange(image, 'b c (h ph) (w pw) -> b (h w) (c ph pw)', ph=patch_h, pw=patch_w)
